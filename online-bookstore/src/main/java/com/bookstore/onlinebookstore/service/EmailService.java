...
import com.bookstore.onlinebookstore.config.EmailConfiguration;
...
public class EmailService {
	...
	public JavaMailSender getJavaMailSender() {
		...
		Properties mailConfigProps = new Properties();
		mailConfigProps.put("mail.smtp.starttls.enable", true);
		mailSenderImpl.setJavaMailProperties(mailConfigProps);
